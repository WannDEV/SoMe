...
export const getUserProfile = async (req, res) => {
    try {
        ...
        const query = 'SELECT username, email, profilePicture, registrationDate FROM users WHERE userID = $1';
...
export const updateUserProfile = async (req, res) => {
    try {
        ...
        const query = 'UPDATE users SET username = $1, email = $2, profilePicture = $3 WHERE userID = $4 RETURNING *';
